...
const technologies = [
  ...
  {
    name: "Редактор языков веб-разработки",
    icon: Code,
    description:
      "Работайте на редакторе кода, который поддерживает HTML, CSS и JS & PHP & MarkDown. Сохраняйте свои проекты и делитесь ими с друзьями!",
    path: "/tools/code"
  },
  {
    name: "Редактор Python",
    icon: FileCode,
    description:
      "Пишите, редактируйте и запускайте код на Python прямо в браузере. Удобный инструмент для обучения и тестирования кода!",
    path: "/tools/python-compiler"
  }
];
